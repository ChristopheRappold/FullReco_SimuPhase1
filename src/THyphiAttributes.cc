...
THyphiAttributes::THyphiAttributes(const std::list<std::string>& type,const std::list<std::string>& option,double FieldScalingFactor,const DataSim& In):Field(nullptr),InputPar(In)
{
