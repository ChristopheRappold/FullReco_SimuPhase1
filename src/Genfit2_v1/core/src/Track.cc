...
//   if (tempID < 0)
//     {
//       tempID += trackPointsWithMeasurement_.size();
//       return getPointWithMeasurementAndFitterInfo(tempID, rep);
//     }
//   else if(tempID >= (int)trackPointsWithMeasurement_.size()) 
//     {
//       return NULL;
//     }
//   else
//     {
//       TrackPoint* tempHit = trackPointsWithMeasurement_.at(tempID);
//       if(tempHit->hasFitterInfo(rep))
// 	return tempHit;
//       else
// 	return NULL;
//     }
