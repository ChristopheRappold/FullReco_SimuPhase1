...
#else
template<class TEOut>
int FullRecoTask<TEOut>::EventLoop(EventWASAUnpack* UnpackEvent, TEOut* OutTree)
#endif
{

  REvent.Clear();
  int return_build = (*dynamic_cast<TBuildUnpack*>(det_build))(UnpackEvent,REvent,OutTree);
