...
template <class Out>
TPrimaryVertex_Si<Out>::TPrimaryVertex_Si(const THyphiAttributes& attribut)
...
template <class Out>
TPrimaryVertex_Si<Out>::~TPrimaryVertex_Si() {}

template <class Out>
void TPrimaryVertex_Si<Out>::InitMT() { att._logger->error("E> Not supposed to be multithreaded !"); }

template <class Out>
ReturnRes::InfoM TPrimaryVertex_Si<Out>::operator()(FullRecoEvent& RecoEvent, Out* OutTree)
{
...
template <class Out>
int TPrimaryVertex_Si<Out>::Exec(FullRecoEvent& RecoEvent, Out* OutTree) { return FinderPrimaryVertex(RecoEvent); }

template <class Out>
ReturnRes::InfoM TPrimaryVertex_Si<Out>::SoftExit(int result_full) {
...
template <class Out>
void TPrimaryVertex_Si<Out>::SelectHists()
{
...
template <class Out>
int TPrimaryVertex_Si<Out>::FinderPrimaryVertex(FullRecoEvent& RecoEvent)
{
...
template <class Out>
void TPrimaryVertex_Si<Out>::simulHitstoRealHits(
...
template <class Out>
void TPrimaryVertex_Si<Out>::MFcheck(std::vector<std::tuple<size_t,TVector3,TVector3>>& HitIdMomPos_Si1,
                             std::vector<std::tuple<size_t,TVector3,TVector3>>& HitIdMomPos_Si2,
...
template <class Out>
void TPrimaryVertex_Si<Out>::TranslationZ_Target_System(double Target_PosZ)
{
  double Dist_to_TransZ = Target_PosZ - 25.; // Reference target PosZ = 25.
...
template <class Out>
void TPrimaryVertex_Si<Out>::CloseDist(std::vector<double>& BeamHit1, std::vector<double>& BeamHit2,
...
template <class Out>
double TPrimaryVertex_Si<Out>::f_function(std::vector<double>& Hit1, std::vector<double>& Hit2, std::vector<double>& PosXYZ)
{
...
template <class Out>
double TPrimaryVertex_Si<Out>::V_function(std::vector<double>& f_vector)
{
  double sum_f  = 0;
  double sum_f2 = 0;
  double v      = 0.;
...
template <class Out>
void TPrimaryVertex_Si<Out>::SpaceDiscretization(double& Xi, double& Xf, size_t& NstepsX, double& Yi, double& Yf,
...
template <class Out>
void TPrimaryVertex_Si<Out>::HitstoTracks(std::vector<std::vector<double> >& HitEnergyPosXY_Si1,
                                  std::vector<std::vector<double> >& HitEnergyPosXY_Si2,
...
template <class Out>
void TPrimaryVertex_Si<Out>::TrackstoVertexPosition(std::vector<std::vector<std::vector<double> > >& CandidateTracks,
                                            std::vector<double>& BeamHit1, std::vector<double>& BeamHit2,
...
template <class Out>
void TPrimaryVertex_Si<Out>::CovarianceMatrix(std::vector<std::vector<std::vector<double> > >& CandidateTracks,
                                      std::vector<double>& BeamHit1, std::vector<double>& BeamHit2,
...
template <class Out>
void TPrimaryVertex_Si<Out>::HitstoDecayTracks(std::vector<std::vector<double> >& HitEnergyPosXY_Si1,
                                       std::vector<std::vector<double> >& HitEnergyPosXY_Si2,
                                       std::vector<double>& BeamHit1, std::vector<double>& BeamHit2,
                                       std::vector<double>& InteractionPointRecons,
                                       std::vector<std::vector<std::vector<double> > >& CandidateDecayTracks)
...
template <class Out>
void TPrimaryVertex_Si<Out>::DecayTrackstoDecayPosition(std::vector<std::vector<std::vector<double> > >& CandidateTracks,
                                                std::vector<double>& InteractionPointRecons,
...
template <class Out>
void TPrimaryVertex_Si<Out>::nGoodEventsCounter(
    std::vector<std::vector<double> >& HitEnergyPosXY,
    std::vector<std::tuple<double, double, double, size_t, double, double, std::string> >& HitEnergyPosXYreal,
...
template <class Out>
void TPrimaryVertex_Si<Out>::RealHitstoRealTracks(
    std::vector<std::tuple<double, double, double, size_t, double, double, std::string> >& HitEnergyPosXYreal_Si1,
    std::vector<std::tuple<double, double, double, size_t, double, double, std::string> >& HitEnergyPosXYreal_Si2,
    std::vector<std::vector<std::vector<double> > >& RealTracks)
{
...
template <class Out>
void TPrimaryVertex_Si<Out>::nGoodTracksCounter(std::vector<std::vector<std::vector<double> > >& CandidateTracks,
                                        std::vector<std::vector<std::vector<double> > >& RealTracks,
...
template <class Out>
void TPrimaryVertex_Si<Out>::nForwardTracksCounter(std::vector<std::vector<std::vector<double> > >& CandidateTracks,
...
template class TPrimaryVertex_Si<MCAnaEventG4Sol>;
template class TPrimaryVertex_Si<Ana_WasaEvent>;
