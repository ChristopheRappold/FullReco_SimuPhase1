...
public:
  ...
  TVertex(std::string t_,const TVector3& v_,double chi2_,int ndf_,const TMatrixT<double>& c_):type(t_),vertex(v_),Chi2(chi2_),Ndf(ndf_),Cov(c_) {}
...
struct ResSolDAF
{
  ...
  int firstHit = -1;
  int lastHit = -1;
  double cov_matrix[6][6] = {{-999.,-999.,-999.,-999.,-999.,-999.},
