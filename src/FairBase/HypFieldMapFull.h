...
#ifndef HYPFIELDMAPFULL_BASE_H
#define HYPFIELDMAPFULL_BASE_H 1

#include "FairField.h"

class TArrayF;
class HypFieldMapFullData;


class HypFieldMapFull : public FairField {
...
public:
   ...
   **/
  HypFieldMapFull(const char* mapName);//, const char* fileType = "R");


  /** Constructor from HypFieldPar **/
  //HypFieldMapFull(HypFieldPar* fieldPar);


  /** Destructor **/
  virtual ~HypFieldMapFull();
  ...
  void SetPosition(Double_t x, Double_t y, Double_t z, Double_t angle);
 ...
 protected:
  ...
  void SetField(const HypFieldMapFullData* data);
