...
#ifndef HYPFIELDMAP_BASE_H
#define HYPFIELDMAP_BASE_H 1

#include "FairField.h"

class TArrayF;
class HypFieldMapData;


class HypFieldMap : public FairField {
...
public:
   ...
   **/
  HypFieldMap(const char* mapName);//, const char* fileType = "R");


  /** Constructor from HypFieldPar **/
  //HypFieldMap(HypFieldPar* fieldPar);
 ...
 protected:
  ...
  void SetField(const HypFieldMapData* data);
