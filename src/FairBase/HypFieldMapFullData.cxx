...
// -------------   Default constructor  ----------------------------------
HypFieldMapFullData::HypFieldMapFullData()
 :fType(1),
  fXmin(0), 
  fXmax(0),
  fYmin(0), 
...
HypFieldMapFullData::HypFieldMapFullData(const char* mapName)
...
// -----   Constructor from HypFieldMapFull   ------------------------------
HypFieldMapFullData::HypFieldMapFullData(const char* name,
				 const HypFieldMapFull& map) 
