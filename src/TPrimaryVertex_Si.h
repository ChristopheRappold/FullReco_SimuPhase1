#ifndef TPRIMARYVERTEX_SI
#define TPRIMARYVERTEX_SI
...
template<class Out>
class TPrimaryVertex_Si final : public TDataProcessInterface<Out> //TDataProcess<FullRecoEvent, Out> //TDataProcessInterface
{
public:
  const THyphiAttributes& att;

  TPrimaryVertex_Si(const THyphiAttributes& attr);
  ~TPrimaryVertex_Si();
