...
THyphiTrack::THyphiTrack(const THyphiTrack& H)
{
  ...
  MomTof = H.MomTof;
  ////////////////////////
  Residu_X_TR1 = H.Residu_X_TR1;
  Residu_X_TR2 = H.Residu_X_TR2;
  Residu_X_DC2 = H.Residu_X_DC2;
  Residu_X_TOF = H.Residu_X_TOF;

  Residu_Y_TR1 = H.Residu_Y_TR1;
  Residu_Y_TR2 = H.Residu_Y_TR2;
  Residu_Y_DC2 = H.Residu_Y_DC2;
  Residu_Y_TOF = H.Residu_Y_TOF;
